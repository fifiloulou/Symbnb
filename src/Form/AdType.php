...
class AdType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('slug', TextType::class, $this->getConfiguration("Adresse web", "Tapez un super titre pour votre annonce"))
            ...
            ->add('introduction', TextType::class, $this->getConfiguration("Introduction", "Donnez une description globale de l'annonce annonce"))
